...
from .views import CustomTokenObtainPairView, InfraOutputViewSet, TerraformPlanViewSet, TerraformCallbackView
...
urlpatterns = [
    ...
    path("terraform/callback/", TerraformCallbackView.as_view(), name="terraform-callback"),
